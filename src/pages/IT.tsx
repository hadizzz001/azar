            ...
            <Grid container sx={{ mb: { xs: 11, sm: 8, md: 0 }, py: { md: '2em', lg: 5 }, width: '100%', justifyContent: { md: 'space-between' }, height: { lg: '700px' } }}>
                    <Grid item xs={12} md={6} lg={6} className={`flex center  col title-trigger1 `}>
                        <Box
                            ...
                            <img
                                src={"https://ucarecdn.com/e8dc651d-d97d-4b6f-a3a4-cf6483d34517/IT2.jpg"}
                                alt="Image"
                                className="img br8" />
                        </Box>
                    ...
                    <Grid
                        ...
                        <Box
                            ...
                            <Typography
                                ...
                                className='clr2 '>
                                We provide high quality IT and maintenance services.
                            </Typography>
                ...
                <Grid container sx={{
                    ...
                    <Grid
                        ...
                        <Box
                            ...
                            <Typography
                                ...
                                className='clr2 '>
                                We repair mobiles, laptops, servers, desktops, TVs, hardwares and inverts.
                            </Typography>
                            <Link href='/contact' className="decor-none">
                    ...
                    <Grid sx={{
                        ...
                        <Box
                            ...
                            <img
                                src={"https://ucarecdn.com/dc1b4536-0c50-4e0d-8e6c-fe107c819313/IT3.jpg"}
                                alt="Image"
                                className="img br8" />
                        </Box>
