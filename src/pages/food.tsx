                    ...
                    <Grid
                        ...
                        <Box
                            ...
                            <Typography
                                ...
                                className='clr2 '>
                                We wholesale quality foods for customers big and small.
                            </Typography>
                ...
                <Grid container sx={{
                    ...
                    <Grid
                        ...
                        <Box
                            ...
                            <Typography
                                ...
                                className='clr2 '>
                                We are one of the lebanese leading food wholesale.
                            </Typography>
                            <Link href='/contact' className="decor-none">
                    ...
                    <Grid sx={{
                        ...
                        <Box
                            ...
                            <img
                                src={"https://ucarecdn.com/4ae98a02-b8c0-4811-9147-5432c2593ea8/food3.jpg"}
                                alt="Image"
                                className="img br8" />
                        </Box>
