            ...
            <Grid container sx={{ mb: { xs: 11, sm: 8, md: 0 }, py: { md: '2em', lg: 5 }, width: '100%', justifyContent: { md: 'space-between' }, height: { lg: '700px' } }}>
                    <Grid item xs={12} md={6} lg={6} className={`flex center  col title-trigger1 `}>
                        <Box
                            ...
                            <img
                                src={"https://ucarecdn.com/3d8920c4-7c0b-4079-9592-68604adcd328/import2.jpg"}
                                alt="Image"
                                className="img br8" />
                        </Box>
                    ...
                    <Grid
                        ...
                        <Box
                            ...
                            <Typography
                                ...
                                className='clr2 '>
                                Import company that supplies companies worldwide while providing the best quality service.
                            </Typography>
                ...
                <Grid container sx={{
                    ...
                    <Grid
                        ...
                        <Box
                            ...
                            <Typography
                                ...
                                className='clr2 '>
                                Scale your business globally with us.
                            </Typography>
                            <Link href='/contact' className="decor-none">
                    ...
                    <Grid sx={{
                        ...
                        <Box
                            ...
                            <img
                                src={"https://ucarecdn.com/00cb148a-5763-4e2a-beb9-922cbe46d415/import3.jpg"}
                                alt="Image"
                                className="img br8" />
                        </Box>
